    ...
    export module MapArea {
        ...
        export class SOMMap extends D3ChartObject {
            ...
            constructor(element: D3.Selection, manyLens: ManyLens) {
                ...
                const {top: offsetTop, right: offsetRight, bottom: offsetBottom, left: offsetLeft, height: offsetHeight, width: offsetWidth} = this._element.node().getBoundingClientRect();
