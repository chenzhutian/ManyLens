...
export class BaseD3Lens extends D3ChartObject {
    ...
    protected _sc_lc_svg: Selection<any> = null;

    protected _lens_circle_svg: Selection<any>;
    protected _lens_circle: Selection<any>;
    ...
    protected _lens_circle_zoom: behavior.Zoom<any> = d3.behavior.zoom();
    protected _lens_circle_drag: behavior.Drag<any> = d3.behavior.drag();
    ...
    public get LensSVGGroup(): Selection<any> {
        return this._lens_circle_svg;
    }
    public set LensSVGGroup(lensG: Selection<any>) {
    ...
    constructor(element: Selection<any>, type: string, manyLens: ManyLens) {
