...
import { Selection, scale, layout } from "d3";
...
export class WordCloudLens extends BaseSingleLens {
    ...
    private _font_size: scale.Pow<any, any> = d3.scale.sqrt();
    private _cloud: layout.Cloud<any> = d3.layout.cloud();
    ...
    private _cloud_text_color: scale.Pow<string[], any>;
