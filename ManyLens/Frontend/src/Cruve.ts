...
import { Selection, svg, scale, time, layout, geom, selection } from "d3";
...
export class Curve extends D3ChartObject {
    ...
    private _curveSvg: Selection<any>;
    private _mainView: Selection<any>;
    private _subView: Selection<any>;

    private _x_scale: scale.Linear<any, any> = d3.scale.linear();
    private _x_axis_gen: svg.Axis = d3.svg.axis();
    private _x_axis: Selection<any>;
    private _y_scale: scale.Linear<any, any> = d3.scale.linear();
    private _y_axis_gen: svg.Axis = d3.svg.axis();
    private _y_axis: Selection<any>;
    private _fisheye_scale: FishEyeOrdinalScale = d3.fisheye.ordinal();
    ...
    private _time_formater: time.Format;
    private _stack_time_id_gen: number = 0;

    private _root: {};
    private _stack_bar_nodes_data: StackNode[];
    private _stack_bar_tree: layout.Tree<any>;
    private _stack_bar_tree_diagonal: svg.Diagonal<any, any>;
    private _stack_bar_node: selection.Update<any>;
    private _stack_bar_link: selection.Update<any>;
    ...
    private _voronoi_bound: geom.Polygon = null;
    private _voronoi: geom.Voronoi<any> = null;
    private _voronoi_color: scale.Ordinal<any, any> = null;
    ...
    private CalVoronoi(fs: Array<Feature>, constR) {
        ...
        var cnt = 0;
        while (cnt < 5) {
            var polygon: geom.Polygon[] = this._voronoi(fs);
            var dist = 0;
