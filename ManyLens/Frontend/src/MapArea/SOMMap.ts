...
export class SOMMap extends D3ChartObject {
    ...
    private _zoom: behavior.Zoom<any>;
    private _move_view_timer: number;

    private _brush_svg: Selection<any>;
    private _brush: svg.Brush<any>;
    private _fromUnitsID: number[];
    private _toUnitsID: number[];

    private _classifier_context_menu: Selection<any> = null;
    private _hightlight_classifier_arrow: Selection<any> = null;
