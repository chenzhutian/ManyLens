    ...
    (function (MapArea) {
        var SOMMap = (function (_super) {
            ...
            function SOMMap(element, manyLens) {
                ...
                var _a = this._element.node().getBoundingClientRect(), offsetTop = _a.top, offsetRight = _a.right, offsetBottom = _a.bottom, offsetLeft = _a.left, offsetHeight = _a.height, offsetWidth = _a.width;
                this._element.attr("height", function () {
                    return this.parentNode.clientHeight - offsetTop + 20;
                });
                ...
                this._heatmap_container.style.left = offsetLeft.toString() + "px";
                this._heatmap_container.style.top = offsetTop.toString() + "px";
                this._heatmap_container.style.height = offsetHeight.toString() + "px";
                this._heatmap_container.style.width = offsetWidth.toString() + "px";
...
/*--------------- Single Lens  ----------------*/
///<reference path = "./BarChartLens.ts" />
///<reference path = "./MapLens.ts" />
///<reference path = "./NetworkLens.ts" />
///<reference path = "./PieChartLens.ts" />
///<reference path = "./TreeNetworkLens.ts"  />
///<reference path = "./WordCloudLens.ts"/>
(function () {
})();
///<reference path = "./BaseSingleLens.ts" />
var ManyLens;
    ...
    (function (MapArea) {
        var WorldMap = (function (_super) {
            ...
            function WorldMap(element, manyLens) {
                ...
                this._zoom = d3.behavior.zoom();
                this._element.attr("height", function () {
                    return this.parentNode.clientHeight - this.getBoundingClientRect().top + 20;
                });
                this._total_width = parseFloat(this._element.style("width"));
                this._total_height = parseFloat(this._element.style("height"));
                this._color
